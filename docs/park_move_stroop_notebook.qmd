...
| 7 | 2025-06-03 | Added extra statistics and analysis of UPDRS and LEDD data. Some formatting in figures updated. |

: Version history

# Notebook rationale

Since we already have a collected dataset, on which we have already run analyses (albeit different analyses), we can take inspiration from Daniël Lakens, for example in [@lakens2024a]:
...
Finished manuscript is located in the Journal of NeuroEngineering and Rehabilitation (JNER):

<https://doi.org/10.1186/s12984-025-01864-w>
