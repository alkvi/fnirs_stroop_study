...
Fstat = GroupStats_oa.lm_anova.F(2);
Fstat_p = GroupStats_oa.lm_anova.pValue(2);
Rsquared = GroupStats_oa.lm_rsq.Ordinary;
Rsquared_adj = GroupStats_oa.lm_rsq.Adjusted;
...
roi_result_oa_aim1.Fstat = repmat(Fstat, size(roi_result_oa_aim1,1),1);
roi_result_oa_aim1.Fstat_p = repmat(Fstat_p, size(roi_result_oa_aim1,1),1);
roi_result_oa_aim1.Rsquared = repmat(Rsquared, size(roi_result_oa_aim1,1),1);
roi_result_oa_aim1.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_oa_aim1,1),1);
...
Fstat = GroupStats_pd.lm_anova.F(2);
Fstat_p = GroupStats_pd.lm_anova.pValue(2);
Rsquared = GroupStats_pd.lm_rsq.Ordinary;
Rsquared_adj = GroupStats_pd.lm_rsq.Adjusted;
...
roi_result_pd_aim1.Fstat = repmat(Fstat, size(roi_result_pd_aim1,1),1);
roi_result_pd_aim1.Fstat_p = repmat(Fstat_p, size(roi_result_pd_aim1,1),1);
roi_result_pd_aim1.Rsquared = repmat(Rsquared, size(roi_result_pd_aim1,1),1);
roi_result_pd_aim1.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_pd_aim1,1),1);
...
roi_result_oa_aim2_1.Fstat = repmat(Fstat, size(roi_result_oa_aim2_1,1),1);
roi_result_oa_aim2_1.Fstat_p = repmat(Fstat_p, size(roi_result_oa_aim2_1,1),1);
roi_result_oa_aim2_1.Rsquared = repmat(Rsquared, size(roi_result_oa_aim2_1,1),1);
roi_result_oa_aim2_1.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_oa_aim2_1,1),1);
...
roi_result_pd_aim2_1.Fstat = repmat(Fstat, size(roi_result_pd_aim2_1,1),1);
roi_result_pd_aim2_1.Fstat_p = repmat(Fstat_p, size(roi_result_pd_aim2_1,1),1);
roi_result_pd_aim2_1.Rsquared = repmat(Rsquared, size(roi_result_pd_aim2_1,1),1);
roi_result_pd_aim2_1.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_pd_aim2_1,1),1);
...
roi_result_oa_aim2_2.Fstat = repmat(Fstat, size(roi_result_oa_aim2_2,1),1);
roi_result_oa_aim2_2.Fstat_p = repmat(Fstat_p, size(roi_result_oa_aim2_2,1),1);
roi_result_oa_aim2_2.Rsquared = repmat(Rsquared, size(roi_result_oa_aim2_2,1),1);
roi_result_oa_aim2_2.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_oa_aim2_2,1),1);
...
roi_result_pd_aim2_2.Fstat = repmat(Fstat, size(roi_result_pd_aim2_2,1),1);
roi_result_pd_aim2_2.Fstat_p = repmat(Fstat_p, size(roi_result_pd_aim2_2,1),1);
roi_result_pd_aim2_2.Rsquared = repmat(Rsquared, size(roi_result_pd_aim2_2,1),1);
roi_result_pd_aim2_2.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_pd_aim2_2,1),1);
...
roi_result_oa_aim2_3.Fstat = repmat(Fstat, size(roi_result_oa_aim2_3,1),1);
roi_result_oa_aim2_3.Fstat_p = repmat(Fstat_p, size(roi_result_oa_aim2_3,1),1);
roi_result_oa_aim2_3.Rsquared = repmat(Rsquared, size(roi_result_oa_aim2_3,1),1);
roi_result_oa_aim2_3.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_oa_aim2_3,1),1);
...
roi_result_pd_aim2_3.Fstat = repmat(Fstat, size(roi_result_pd_aim2_3,1),1);
roi_result_pd_aim2_3.Fstat_p = repmat(Fstat_p, size(roi_result_pd_aim2_3,1),1);
roi_result_pd_aim2_3.Rsquared = repmat(Rsquared, size(roi_result_pd_aim2_3,1),1);
roi_result_pd_aim2_3.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_pd_aim2_3,1),1);
...
roi_result_oa_aim3.Fstat = repmat(Fstat, size(roi_result_oa_aim3,1),1);
roi_result_oa_aim3.Fstat_p = repmat(Fstat_p, size(roi_result_oa_aim3,1),1);
roi_result_oa_aim3.Rsquared = repmat(Rsquared, size(roi_result_oa_aim3,1),1);
roi_result_oa_aim3.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_oa_aim3,1),1);
...
roi_result_pd_aim3.Fstat = repmat(Fstat, size(roi_result_pd_aim3,1),1);
roi_result_pd_aim3.Fstat_p = repmat(Fstat_p, size(roi_result_pd_aim3,1),1);
roi_result_pd_aim3.Rsquared = repmat(Rsquared, size(roi_result_pd_aim3,1),1);
roi_result_pd_aim3.Rsquared_adj = repmat(Rsquared_adj, size(roi_result_pd_aim3,1),1);
